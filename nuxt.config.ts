...
export default defineNuxtConfig({
  ...
  image: {
    ...
    // поэтому используем ipxStatic: ресайз и конвертация в WebP происходят
    // на этапе `nuxt generate` (crawler дозапрашивает /_ipx/... маршруты
    // и сохраняет готовые файлы), а на проде сервер IPX не нужен.
    provider: 'ipxStatic'
  },
